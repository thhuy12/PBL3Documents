...
void VanetRoutingExperiment::SetupScenario()
{
  ...
  else if (m_scenario == 2)
  {
    ...
    m_traceFile = "/home/thanhhuy/Sumo/2024-12-23-09-30-22/mobility.tcl";
    m_logFile = "vanet.log";
    m_mobility = 1;
    m_nNodes = 21;
